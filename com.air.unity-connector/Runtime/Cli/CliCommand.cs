...
{
    /// <summary>Shared unity-cmd runtime binding; inherit <see cref="CliCommand"/> or <see cref="CliCommand{TParams}"/>.</summary>
    ...
    /// <summary>unity-cmd CLI command with bound parameters.</summary>
